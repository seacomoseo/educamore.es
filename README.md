...
- If new project (not fork):
  - Copy [educamore.es project files](https://github.com/educamore/educamore.es)
...
- `README.md` ⏩ edit baseURL ("educamore.es") + delete steps bit by bit
- Design
...
- If Netlify
  - [`Domain Management / settings`](https://app.netlify.com/sites/educamore/settings/domain)
  - `Add custom domain`
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/educamore/domains)
  - `Set up a custom domains`
  - `educamore.es`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.educamore.es`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/educamore/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de educamore.es`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/educamore/forms)
...
1. [Servicios educamore.es](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
...
```md
*ENTREGA WEB educamore.es*

Te dejo aquí este mensaje como referencia (también te lo paso por email con el asunto `ENTREGA WEB educamore.es`).
...
```
Asunto: ENTREGA WEB educamore.es
Cuerpo:
