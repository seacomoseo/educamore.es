...
## ::favorite:: La teoría detrás de una emoción
...
> ::svg:ditto:: Es normal que tengas miedo, pero puedes estar tranquilo, yo estoy aquí para protegerte ::svg:ditto::

> ::svg:ditto:: Yo de pequeña también tenía miedo a la oscuridad, sé cómo te sientes, podemos dejar una lucecita encendida por la noche ::svg:ditto::

El miedo y la inseguridad pueden obstaculizar el aprendizaje, cerrando las conexiones más avanzadas del cerebro.

## ::sentiment_very_dissatisfied:: Terrores nocturnos
...
## ::bookmark_heart:: Cuentos para gestionar los miedos
...
- ::book_2::  **Cannon, W. B. (1939).** _La sabiduría del cuerpo_. W.W. Norton & Company.
- ::book_2::  **Panksepp, J. (1998).** _Neurociencia afectiva: Los fundamentos de las emociones humanas y animales_. Oxford University Press.
- ::book_2::  **Sapolsky, R. M. (2004).** _Por qué las cebras no tienen úlceras: Una guía actualizada sobre el estrés, las enfermedades relacionadas con el estrés y cómo afrontarlo_. W.H. Freeman and Company.
...
- ::visibility::      [Trauma y técnica EMDR](https://neuro-class.com/trauma-y-tecnica-emdr-para-que-sirve/)
- ::brand:youtube::   [El miedo, una alarma mental para proteger la integridad](https://www.youtube.com/watch?v=WdNMXcIoyIc&t=7s)
- ::picture_as_pdf::  [Los miedos en los niños](https://www.murciaeduca.es/cpmanuelaromero/sitio/upload/LOS_MIEDOS_EN_LOS_NIN771OS-2_compressed.pdf.pdf)

{{% / bg %}}

> ::svg:ditto:: Si el miedo ocupa tu cabeza no dejas espacio para tus sueños ::svg:ditto::
